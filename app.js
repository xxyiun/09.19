const weddingConfig = {
  ...
  weddingDate: '2026-09-19T00:00:00+08:00',
  dateDot: '2026 · 09 · 19',
  ...
  venue: '犍为天波酒店',
  venueShort: '天波酒店',
  navigationUrl: 'https://uri.amap.com/search?keyword=%E7%8A%8D%E4%B8%BA%E5%A4%A9%E6%B3%A2%E9%85%92%E5%BA%97&src=stardew-wedding&callnative=1',
  schedule: [
    { label: '签到', time: '11:30', description: '领取今日任务，与老朋友相见' },
    { label: '仪式', time: '12:00', description: '见证拥抱、誓言与交换戒指' },
    { label: '喜宴', time: '12:20', description: '共享一场丰盛的秋日宴席' },
